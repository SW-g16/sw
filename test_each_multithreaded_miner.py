...
class TestEachMulti(unittest.TestCase):
    ...
    def test_parltrack(self):
        self.assertTrue(self.miner_manager.parltrack_miner.mine())

    def test_govtrack(self):
        self.assertTrue(self.miner_manager.govtrack_miner.mine())
